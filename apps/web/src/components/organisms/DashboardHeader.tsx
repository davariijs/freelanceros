...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({
  ...
  const { toggleLocale, setTheme, theme, locale, t } =
    useApp();
  ...
  return (
    <header className="h-16 border-b border-neutral-200 dark:border-neutral-800 px-6 md:px-8 flex items-center justify-between bg-neutral-50 dark:bg-neutral-950 transition-colors duration-200">
      ...
      <div className="flex items-center gap-2 p-1 rounded-full border border-neutral-200 dark:border-neutral-800 bg-neutral-100/50 dark:bg-neutral-900/50 backdrop-blur-sm">
        <Button
