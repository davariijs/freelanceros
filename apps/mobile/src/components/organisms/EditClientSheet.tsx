...
export const EditClientSheet = React.forwardRef<BottomSheet, EditClientSheetProps>(
          ...
          <View className="gap-5">
            ...
            <View className="gap-4">
              <View className="gap-1.5">
                <Text className="text-xs font-semibold text-neutral-500 dark:text-neutral-400">{t.clientName} *</Text>
                <Controller
                  control={control}
                  name="name"
                  render={({ field: { onChange, value } }) => (
                    <View className={`border rounded-xl px-3 h-11 justify-center ${errors.name ? "border-red-500 bg-red-500/5" : (isDark ? "border-neutral-800 bg-neutral-900/50" : "border-neutral-300 bg-neutral-50")}`}>
                      <BottomSheetTextInput
              ...
              <View className="gap-1.5">
                <Text className="text-xs font-semibold text-neutral-500 dark:text-neutral-400">{t.clientEmail}</Text>
                <Controller
                  control={control}
                  name="email"
                  render={({ field: { onChange, value } }) => (
                    <View className={`border rounded-xl px-3 h-11 justify-center ${errors.email ? "border-red-500 bg-red-500/5" : (isDark ? "border-neutral-800 bg-neutral-900/50" : "border-neutral-300 bg-neutral-50")}`}>
                      <BottomSheetTextInput
                        className={`text-sm h-full ${isDark ? "text-neutral-100" : "text-neutral-900"}`}
                        value={value}
                        onChangeText={onChange}
              ...
              <View className="gap-1.5">
                <Text className="text-xs font-semibold text-neutral-500 dark:text-neutral-400">{t.phone || "Phone"}</Text>
                <Controller
                  control={control}
                  name="phone"
                  render={({ field: { onChange, value } }) => (
                    <View className={`border rounded-xl pl-3 pr-12 h-11 justify-center relative ${isDark ? "border-neutral-800 bg-neutral-900/50" : "border-neutral-300 bg-neutral-50"}`}>
                      <BottomSheetTextInput
                        className={`text-sm h-full ${isDark ? "text-neutral-100" : "text-neutral-900"}`}
                        value={value}
                        onChangeText={onChange}
              ...
              <View className="gap-1.5">
                <Text className="text-xs font-semibold text-neutral-500 dark:text-neutral-400">{t.website || "Website"}</Text>
                <Controller
                  control={control}
                  name="website"
                  render={({ field: { onChange, value } }) => (
              ...
              <View className="flex-col gap-1.5">
                <Text className="text-xs font-semibold text-neutral-500 dark:text-neutral-400">{t.status}</Text>
                <Select value={statusField.value} onChange={statusField.onChange} options={statusOptions} isDark={isDark} />
              </View>
              ...
              <View className="gap-3 pt-3 border-t border-neutral-200/50 dark:border-neutral-800/50">
                <View className="flex-row items-center justify-between flex">
                  <Text className="text-xs font-bold text-neutral-500 dark:text-neutral-400">{t.socialAccounts || "Social Handles"}</Text>
                  <Button
                    variant="secondary"
                  ...
                  >
                    ...
                    <Text className="text-[10px] font-bold">{t.addSocial || "Add"}</Text>
                  </Button>
                </View>
                  ...
                  {fields.map((field, index) => (
                    <View key={field.id} className="flex-row items-center gap-2">
                      <Controller
                        ...
                        render={({ field: { onChange, value } }) => (
                          <View className={`w-1/3 h-10 px-3 rounded-lg border justify-center ${isDark ? "border-neutral-800" : "border-neutral-300 bg-white"}`}>
                            <BottomSheetTextInput
                      ...
                      <Controller
                        ...
                        render={({ field: { onChange, value } }) => (
                          <View className={`flex-1 h-10 pl-3 pr-10 rounded-lg border justify-center ${isDark ? "border-neutral-800" : "border-neutral-300 bg-white"}`}>
                            <BottomSheetTextInput
            ...
            <View className={`pt-4 border-t mt-6 ${isDark ? "border-neutral-900" : "border-neutral-200"}`}>
              {isConfirmingDelete ? (
                <View className="flex-col gap-3 p-3 bg-red-500/5 rounded-xl border border-red-500/10">
                  ...
                  <View className="flex-row gap-2 w-full">
                    ...
                    >
                      <Text className="text-xs font-bold text-white">{t.delete}</Text>
                    </Button>
                  </View>
                </View>
              ) : (
                <View className="flex-row justify-between items-center">
                  ...
                  <View className="flex-row gap-3">
                    <Button type="button" variant="secondary" onPress={onSuccess} isDark={isDark}>
                      {t.cancel}
                    </Button>
                    <Button onPress={handleSubmit(onSubmit)} isDark={isDark}>
                      <Text className={`text-xs font-bold ${isDark ? "text-neutral-950" : "text-white"}`}>{t.save}</Text>
                    </Button>
                  </View>
                </View>
              )}
