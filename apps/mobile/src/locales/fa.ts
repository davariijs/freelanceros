export const fa = {
  ...
  toastCannotOpenDialer: "امکان باز کردن شماره‌گیر وجود ندارد",
  toastCannotOpenWebsite: "امکان باز کردن وب‌سایت وجود ندارد",
  clientIdLabel: "شناسه",
  addSocial: "افزودن شناسه",
  socialAccounts: "حساب‌های اجتماعی",
  platformPlaceholder: "پلتفرم (مثلاً تلگرام)",
  idPlaceholder: "آی‌دی یا شماره تماس",
  ...
  createClient: "ایجاد مشتری جدید",
  clientNameRequired: "نام مشتری الزامی است",
  delete: "حذف",
  clients: "مشتریان",
  clientsDescription: "مدیریت و پایش اطلاعات مشتریان و شبکه‌های اجتماعی آن‌ها.",
  sharedLoadingPortal: "در حال بارگذاری اطلاعات...",
  noClients: "هیچ مشتری ثبت نشده است.",
  projects: "پروژه‌ها",
  projectsDescription: "مدیریت و پایش ددلاین‌ها و پیشرفت پروژه‌های کاری شما.",
  createProject: "ایجاد پروژه جدید",
  projectTimeline: "تایم‌لاین پروژه‌ها",
  noProjects: "هیچ پروژه‌ای ثبت نشده است.",
  title: "عنوان پروژه",
  placeholderProjectDate: "تاریخ سررسید",
  priority: "اولویت",
  selectClient: "انتخاب مشتری",
  statusPlanning: "برنامه‌ریزی",
  statusActive: "فعال",
